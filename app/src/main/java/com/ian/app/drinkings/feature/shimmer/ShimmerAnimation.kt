package com.ian.app.drinkings.feature.shimmer
...
import com.ian.app.drinkings.ui.theme.ShimmerColorShades

@Composable
fun ShimmerAnimation(shimmerScreen: @Composable (brush: Brush) -> Unit) {
    /**
