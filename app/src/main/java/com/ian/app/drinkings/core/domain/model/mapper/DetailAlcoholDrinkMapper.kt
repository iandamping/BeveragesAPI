...
fun ResponseDetailAlcoholDrink.mapRemoteAlcoholDrinkToDomain(): DetailAlcoholDrink {
    return DetailAlcoholDrink(
...
fun EntityDetailAlcoholDrink.mapLocalAlcoholDrinkToDomain(): DetailAlcoholDrink {
    return DetailAlcoholDrink(
...
fun DetailAlcoholDrink.mapAlcoholDrinkToData(): EntityDetailAlcoholDrink {
    return EntityDetailAlcoholDrink(
        localDrinkId = null,
        remoteIdDrink = remoteIdDrink,
        strDrink = strDrink,
        strDrinkAlternate = strDrinkAlternate,
